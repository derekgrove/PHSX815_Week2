...
class Random:
    ...
    # function that returns a 1, 2, 3, 4, 5, or 6 with *almost* equal probabilities,
    # 6 has ever so slightly more of a probability, prob(6) = 0.166666667
    def Six_Sided_Die(self, p=0.1666666666):
        if p < 0. or p > 1.:
            return 1
